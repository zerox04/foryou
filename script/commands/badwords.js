...
const loadBannedWords = threadID => {
  const wordFile = path.join(__dirname, `../commands/tmp/${threadID}.json`);
...
// Downloaded from https://neanmart-botcmds.onrender.com/raw/Badwords26

/*
Name: Badwords 
ID: Badwords26
Description: Badwords for mirai version by Jonell Magallanes (JONELL CC)
*/